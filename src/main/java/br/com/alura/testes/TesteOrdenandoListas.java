...
import java.util.Comparator; //Comparator é melhor do que a Classe Collections
...
Sendo assim, como é chamada apenas uma vez, basta criar uma classe anônima
